...
export class KycComponent implements OnInit {
  ...
  constructor(private router: Router,private http: HttpClient,private os:OrdersService, private modalService: NgbModal, private formBuilder: UntypedFormBuilder) {
